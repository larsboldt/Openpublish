 ...
 */
 ?>
<h3><?php echo opTranslation::getTranslation('_sort_categories', $opPluginName) ?> | <?php echo opTranslation::getTranslation('_documents', $opPluginName) ?>
...
<div id="content-plugin">
    <form id="adminForm" method="post" action="/admin/opDocuments/categorySort">
        <div class="opAdminFormItem">
            ...
            <span class="input-shadow"><select id="parentSelect" onchange="window.location='/admin/opDocuments/categorySort/' + this.value"><option value="0">- <?php echo opTranslation::getTranslation('_root', $opPluginName) ?> -</option>
                <?php
