 ...
 */
?>
<h3><?php echo opTranslation::getTranslation('_categories', $opPluginName) ?> | <?php echo opTranslation::getTranslation('_gallery', $opPluginName) ?>
    ...
    <span class="action-right-btns">
        <a href="/admin/opGallery/categoryNew" title="<?php echo opTranslation::getTranslation('_new_category', $opPluginName) ?>"><span><img src="<?php echo $opPluginPath ?>icons/clear-folder--plus.png" width="16" height="16" alt="<?php echo opTranslation::getTranslation('_new_category', $opPluginName) ?>" class="table-icon" /> <?php echo opTranslation::getTranslation('_new_category', $opPluginName) ?></span></a>
        ...
        <a href="/admin/opGallery/categorySort" title="<?php echo opTranslation::getTranslation('_sort_categories', $opPluginName) ?>"><span><img src="<?php echo $opPluginPath ?>icons/sort-alphabet.png" width="16" height="16" alt="<?php echo opTranslation::getTranslation('_sort_categories', $opPluginName) ?>" class="table-icon" /> <?php echo opTranslation::getTranslation('_sort_categories', $opPluginName) ?></span></a>
        <a href="/admin/opGallery" title="<?php echo opTranslation::getTranslation('_back', $opPluginName) ?>"><span><img src="<?php echo $opPluginPath ?>icons/arrow-180-medium.png" width="16" height="16" alt="<?php echo opTranslation::getTranslation('_back', $opPluginName) ?>" class="table-icon" /> <?php echo opTranslation::getTranslation('_back', $opPluginName) ?></span></a>
    </span>
</h3>
<form method="post" action="/admin/opGallery/categoryDelete" id="adminForm">
